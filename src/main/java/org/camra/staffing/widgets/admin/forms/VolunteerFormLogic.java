package org.camra.staffing.widgets.admin.forms;
...
import org.camra.staffing.widgets.admin.grids.AreaSelectorGrid;
...
public class VolunteerFormLogic extends VolunteerForm {
    ...
    public void editVolunteer(VolunteerDTO volunteerDTO) {
        ...
        List<AreaSelectorDTO> areaList = volunteerService.getAreaSelectors(volunteerDTO.getId());
